package com.example.lib_easyphotos.ui;
...
import com.example.lib_easyphotos.R;
import com.example.lib_easyphotos.constant.Code;
import com.example.lib_easyphotos.constant.Key;
import com.example.lib_easyphotos.constant.Type;
import com.example.lib_easyphotos.models.ad.AdListener;
import com.example.lib_easyphotos.models.album.AlbumModel;
import com.example.lib_easyphotos.models.album.entity.Photo;
import com.example.lib_easyphotos.result.Result;
import com.example.lib_easyphotos.setting.Setting;
import com.example.lib_easyphotos.ui.adapter.AlbumItemsAdapter;
import com.example.lib_easyphotos.ui.adapter.PhotosAdapter;
import com.example.lib_easyphotos.ui.dialog.LoadingDialog;
import com.example.lib_easyphotos.ui.widget.PressedTextView;
import com.example.lib_easyphotos.utils.Color.ColorUtils;
import com.example.lib_easyphotos.utils.String.StringUtils;
import com.example.lib_easyphotos.utils.bitmap.BitmapUtils;
import com.example.lib_easyphotos.utils.media.DurationUtils;
import com.example.lib_easyphotos.utils.media.MediaScannerConnectionUtils;
import com.example.lib_easyphotos.utils.permission.PermissionUtil;
import com.example.lib_easyphotos.utils.settings.SettingsUtils;
import com.example.lib_easyphotos.utils.system.SystemUtils;
import com.example.lib_easyphotos.utils.uri.UriUtils;
    ...
    private void toAndroidCamera(int requestCode) {
        ...
        if (cameraIntent.resolveActivity(getPackageManager()) != null ||
            ...
            if (mTempImageFile != null && mTempImageFile.isFile()) {
                ...
                // 这里我在模拟器(Android 7.1)上试的时候 会崩掉 ActivityNotFoundException
                try {
                    startActivityForResult(cameraIntent, requestCode);
                } catch (Exception e) {
                    e.printStackTrace();
